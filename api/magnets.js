...
<html>
  <body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;background:#f5f5f5;margin:0;padding:24px;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:8px;overflow:hidden;">
      ...
      <tr><td style="padding:8px 32px 24px 32px;"><a href="${pdfUrl}" clicktale="0" style="display:inline-block;background:${color};color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;font-size:16px;">Download the PDF &rarr;</a></td></tr>
      <tr><td style="padding:8px 32px 16px 32px;color:#555;font-size:13px;line-height:1.5;">If the button doesn't work, paste this link into your browser:<br/><a href="${pdfUrl}" clicktale="0" style="color:${color};">${pdfUrl}</a></td></tr>${siteLinksBlock}${affiliateBlock}

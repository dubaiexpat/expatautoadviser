# Converting Your Overseas Driving Licence in Hong Kong
...
Applicants typically take driving lessons with a Hong Kong driving school before the road test — the examiner routes and expectations are quite specific. Expect to budget HK$5,000–HK$8,000 for driving school packages including both written and road test preparation.
...
- **Class 1** — Private car
- **Class 2** — Light goods vehicle (≤ 5.5 tonnes)
- **Class 3** — Medium goods vehicle
- **Class 4** — Private light bus
- **Class 5** — Public light bus
- **Motorcycle** — separate qualification required
...
- A mainland China driving licence (converted from your HK licence — an additional process with the Guangdong PSB)
...
**Can I drive immediately after passing the HK road test?**
Yes, once your probationary licence is issued — typically within days of passing.

**Do I need to surrender my overseas licence?**
No. You can hold both your HK and overseas licence simultaneously.

**What if I fail the road test?**
You can retake. Most candidates pass on the first or second attempt after proper instruction.

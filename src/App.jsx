  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/singapore/calculators" element={<Singapore section="calculators" />} />
        <Route path="/singapore/garage-finder" element={<Singapore section="garages" />} />
        ...
        <Route path="/hongkong/calculators" element={<HongKong section="calculators" />} />
        <Route path="/hongkong/garage-finder" element={<HongKong section="garages" />} />
      </Routes>
    </BrowserRouter>
  );
}
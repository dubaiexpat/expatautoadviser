...
export default function HKMOTMaintenance() {
  return (
    <Layout city="hk" title="MOT & Car Maintenance in Hong Kong for Expats" description="Everything expats need to know about Hong Kong car MOT: when it's required, approved inspection centres, what gets checked, and how to find a trustworthy mechanic.">

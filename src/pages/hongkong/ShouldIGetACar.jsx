  ...
  return (
    <Layout city="hk" title="Should I Get a Car in Hong Kong?" description="Honest advice for expats deciding whether to buy or lease a car in Hong Kong. MTR alternatives, where a car makes sense, and a practical decision guide.">
      <div style={{maxWidth:760}}>
        ...
        <h2 style={h2}>The MTR is excellent — in the right places</h2>
        <p style={body}>Hong Kong's MTR is fast, reliable, air-conditioned, and covers most of Hong Kong Island, Kowloon, and significant parts of the New Territories. If you live in Central, Wan Chai, Causeway Bay, or anywhere within easy walking distance of an MTR station — you genuinely may not need a car.</p>
        ...
        <p style={body}>Move east to Sai Kung, south to Stanley or Repulse Bay, or into the New Territories — and the MTR becomes useless or irrelevant. The South Side and eastern NT are served by buses that run infrequently and take forever. Sai Kung has no MTR at all.</p>
        ...
        <p style={body}>Cars in Hong Kong are expensive to run. Petrol runs at <strong>HKD $24–27/litre</strong>. Monthly parking in most urban areas costs <strong>HKD $2,000–$6,000</strong>. Add insurance, annual vehicle licence, and maintenance, and you're looking at HKD $6,000–$12,000/month in total running costs for a typical mid-range car.</p>

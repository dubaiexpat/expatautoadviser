  ...
  return (
    <Layout city="hk" title="Electric Vehicles in Hong Kong: Expat Guide" description="EV buying and ownership in Hong Kong for expats: FRT concessions, One-for-One Replacement Scheme, charging infrastructure, popular EV models, and whether an EV makes sense for you." relatedLinks={[{ label: 'Buying Guide', to: '/hongkong/buying-guide' }, { label: 'Leasing Guide', to: '/hongkong/leasing-guide' }, { label: 'FRT Tax Explained', to: '/hongkong/frt-tax-explained' }]}>
      <div style={{maxWidth:760}}>
        ...
        <p style={body}>With petrol running at <strong>HKD $24â27/litre</strong> â among the world's highest â the running cost savings of an EV in Hong Kong are substantial. The government has also historically provided strong purchase incentives. And given that most HK driving is urban or suburban (distances are short), range anxiety is rarely an issue.</p>
        ...
        <div style={{background:"white",border:"1px solid #e5e7eb",borderRadius:10,padding:24,margin:"16px 0 28px"}}>
          {[["ð  Home charging","Landed properties: straightforward to install a home charger. High-rise buildings: increasingly installing EV chargers in car parks, but coverage is still patchy â check before you buy."],
            ["ð Tesla Superchargers","Multiple Supercharger sites across HK Island, Kowloon, and NT. Coverage is strong for Tesla owners."],
            ["â¡ CLP and HKE chargers","Both main utilities (CLP and HK Electric) operate public charging networks. Download their apps (CLP EV Charging, HKE GO) for locations."],
            ["ð¢ Car park charging","Many commercial buildings and shopping centres (IFC, Pacific Place, MegaBox) have EV bays. Availability is growing fast."],
          ].map(([type, detail]) => (
        ...
        <div style={{background:"white",border:"1px solid #e5e7eb",borderRadius:10,padding:24,margin:"16px 0 28px"}}>
          {[["â Good fit for EV","You have home charging or secure EV access in your building. You drive primarily in urban HK or NT. You plan to stay 2+ years. You're buying new and can use the FRT concession."],
            ["â ï¸ Consider carefully","You live in a high-rise without EV charging provision. You drive long distances frequently. You need a used car and the used EV market is thinner than petrol equivalents."],
          ].map(([label, detail]) => (
        ...
        <PatrickTip city="hk">"I drove petrol in HK, and given the fuel prices I paid, I'd seriously consider EV next time. The one thing to sort first is charging â if your building has it, or you have a house with a garage, it's a no-brainer. If you're in a flat without charging sorted, that's the blocker. Check the building before the car."</PatrickTip>
      </div>
    </Layout>
  );
}

...
export default function HKInsuranceGuide() {
  return (
    <Layout city="hk" title="Car Insurance in Hong Kong for Expats" description="Car insurance in Hong Kong explained for expats: third-party vs comprehensive, transferring your No Claims Bonus from overseas, typical premiums, and recommended brokers.">

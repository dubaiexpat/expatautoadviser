    ...
    <Layout city="hk" title="Hong Kong First Registration Tax (FRT) Explained" description="FRT in Hong Kong explained for expats: what it is, how it's calculated, progressive bands with worked examples, EV exemptions, and annual licence fees." relatedLinks={[{ label: 'Buying Guide', to: '/hong-kong/buying-guide' }, { label: 'Insurance Guide', to: '/hong-kong/insurance-guide' }, { label: 'Cost Calculator', to: '/hong-kong/calculators' }]}>
      ...
      <div style={{maxWidth:760}}>
        ...
        <div style={{background:"#f0fdfa",border:"1px solid #99f6e4",borderRadius:10,padding:24,margin:"16px 0 28px"}}>
          {[["First $150,000 @ 46%","= HKD $69,000"],["Next $150,000 @ 86%","= HKD $129,000"],["Remaining $20,000 @ 115%","= HKD $23,000"],["Total FRT","= HKD $221,000"]].map(([c,r]) => (
        ...
        <p style={body}>Battery electric vehicles benefit from FRT concessions. There are two tiers: under the <strong>One-for-One Replacement Scheme</strong> (where you scrap an existing vehicle when buying a new EV), the concession is up to <strong>HKD $172,500</strong>. Without a trade-in, the <strong>general EV concession</strong> is up to <strong>HKD $58,500</strong>. <strong style={{color:"#CC0000"}}>Note: this scheme expires on 31 March 2026.</strong> After that date, no FRT concessions will apply to EVs unless a replacement is announced. Verify the latest status at td.gov.hk.</p>

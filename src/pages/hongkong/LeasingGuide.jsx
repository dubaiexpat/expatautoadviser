...
// Hong Kong street â Moke or similar car on HK roads
const HERO_IMG = "https://images.unsplash.com/photo-1507941097613-9f2157b69235?w=1200&q=80";

const faqItems = [
  { q: "Can you lease a car in Hong Kong?", a: "Yes, though it's less common than in Singapore. Operating leases (full-service) are offered by several providers, typically for 1â3 year terms. Monthly rates are generally higher than Singapore but you avoid the large upfront costs of buying." },
  { q: "What's included in a typical HK lease?", a: "Most HK operating leases include the car, maintenance, insurance, and road tax. You pay for fuel and tolls. Mileage limits typically range from 2,000â3,000 km/month." },
  ...
  { q: "Is leasing or buying cheaper in HK?", a: "For most expats (2â4 year assignments), leasing is cheaper once you account for the First Registration Tax (FRT) on purchase and the hassle of selling before you leave. For stays over 5 years, buying can make more sense." },
  { q: "What happens at the end of the lease?", a: "You simply return the car. There are no FRT or resale complexities. Most providers allow early termination with 1â2 months' notice, though penalties may apply." },
];
...
export default function HKLeasingGuide() {
  return (
    <Layout city="hk" active="Leasing Guide" relatedLinks={[{ label: 'Should I Get a Car?', to: '/hongkong/should-i-get-a-car' }, { label: 'Insurance Guide', to: '/hongkong/insurance-guide' }, { label: 'EV Guide', to: '/hongkong/ev-guide' }, { label: 'Cost Calculator', to: '/hongkong/calculators' }]}>
      ...
      <p style={{ ...body, fontSize: 17, color: "#6b7280" }}>Buying is the norm in HK â but for shorter assignments or those who want simplicity, leasing is a legitimate and increasingly popular option.</p>
      ...
      <div style={{ overflowX: "auto", margin: "16px 0 28px" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14, background: "white", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }}>
          ...
          <tbody>
            {[
              ["Upfront cost", "Low (1â2 months deposit)", "High (FRT + purchase price)"],
              ...
              ["FRT (First Reg Tax)", "Not applicable", "100â115% of vehicle value"],
      ...
      <h2 style={h2}>Typical lease costs in Hong Kong (2025â26)</h2>
      <div style={{ overflowX: "auto", margin: "16px 0 28px" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14, background: "white", border: "1px solid #e5e7eb", borderRadius: 10, overflow: "hidden" }}>
          <thead>
            <tr style={{ background: "#f9fafb" }}>
          ...
          <tbody>
            {[
              ["Economy", "Toyota Vios, Honda Jazz", "HKD $7,000â$10,000"],
              ["Mid-range", "Toyota Camry, Mazda CX-5", "HKD $10,000â$15,000"],
              ["Premium", "BMW 3 Series, Mercedes C-Class", "HKD $15,000â$22,000"],
              ["Luxury / SUV", "BMW X5, Mercedes GLE", "HKD $22,000â$35,000"],
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 10, margin: "16px 0 28px" }}>
        {[
          ["â", "Comprehensive insurance", "Included in most leases"],
          ["â", "Annual road tax (vehicle licence)", "Included"],
          ["â", "Scheduled servicing", "At authorised dealer"],
          ["â", "Replacement vehicle", "If car is in for repairs"],
          ["â", "Fuel", "Your cost"],
          ["â", "Tunnel tolls & parking", "Your cost"],
          ["â", "Excess kilometres", "Charged at end of term"],
      ...
      <p style={body}>Hong Kong drives on the left (same as the UK and Australia). Roads are generally well-maintained but can be narrow and steep in residential areas, particularly on the Peak and in Sai Kung. Traffic in the Cross-Harbour Tunnel and during rush hours can be severe â factor this into your commute calculations.</p>
      <p style={body}>Parking is expensive and scarce in urban areas. Monthly parking in Central or Wan Chai can cost HKD $4,000â$8,000 per month. If you live in a building with allocated parking this is less of an issue, but it's worth checking before you commit to a car.</p>

      <h2 style={h2}>Fuel costs</h2>
      <p style={body}>Petrol in Hong Kong is among the most expensive in the world â typically HKD $21â$24 per litre. A typical 2,000 km/month driver will spend HKD $2,500â$4,000/month on fuel. Electric vehicles are gaining traction; home charger installation is possible in most private buildings with management approval.</p>

      <AffiliateBox
        city="hk"
        type="leasing"
        title="Hong Kong Car Leasing â Recommended Providers"
        partners={[

...
const HK_GUIDES = [
  {
    ...
    desc: 'Public transport is world-class — but is a car still worth it for you?',
  ...
  },
  {
    ...
    desc: 'FRT, registration tax, and how to actually buy a car in Hong Kong.',
  ...
  },
  {
    ...
    desc: 'Corporate leasing vs personal lease — what works for expats.',
  ...
  },
  {
    ...
    desc: 'First Registration Tax is hefty. Here\'s exactly how it\'s calculated.',
  ...
  },
  {
    ...
    desc: 'EV incentives, charging infrastructure, and the best EV choices in HK.',
  ...
  },
  {
    ...
    desc: 'Convert your foreign licence to a Hong Kong one — who qualifies and how.',
  ...
  },
  {
    ...
    desc: 'Statutory inspection, trusted workshops, and keeping costs down.',
  ...
  },
  {
    ...
    desc: 'FRT calculator, true-cost-of-ownership tool, tunnel toll guide.',
...
export default function HongKong() {
  return (
    <Layout
      city="hk"
      title="Hong Kong Car Guides for Expats"
      description="Everything expats need to know about owning, buying, leasing and insuring a car in Hong Kong."
      relatedLinks={[
        { label: 'FRT Explained', to: '/hongkong/frt-tax-explained' },
      ...
      <div style={{ maxWidth: 820 }}>
        ...
        >
          ...
          <div>
            ...
            >
              Hong Kong Car Guides
            </h1>
            <p style={{ fontSize: '0.82rem', color: '#8892a4', margin: '0.2rem 0 0' }}>
              Everything an expat needs to navigate Hong Kong's car market
            </p>
          </div>
        </div>

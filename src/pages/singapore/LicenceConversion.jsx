  ...
  return (
    <Layout city="sg" title="Driving Licence Conversion in Singapore for Expats" description="Step-by-step guide to converting your foreign driving licence in Singapore. Which nationalities qualify, costs, timing, and the Traffic Police process." relatedLinks={[{ label: 'Should I Get a Car?', to: '/singapore/should-i-get-a-car' }, { label: 'Leasing Guide', to: '/singapore/leasing-guide' }, { label: 'Buying Guide', to: '/singapore/buying-guide' }]}>
      <div style={{maxWidth:760}}>
        ...
        <p style={body}>Singapore allows holders of licences from certain countries to convert directly â no theory test, no practical test, just paperwork. Qualifying countries include:</p>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:8,margin:"16px 0 28px"}}>
          {countries.map(c => <div key={c} style={{background:"#f0fdf4",border:"1px solid #86efac",borderRadius:6,padding:"8px 12px",fontSize:13,color:"#166534",fontWeight:500}}>â {c}</div>)}
        </div>
        ...
        <div style={{margin:"16px 0 28px"}}>
          {[{n:"1",t:"Check your eligibility",d:"Confirm your nationality qualifies. Your foreign licence must be valid (not expired)."},
            ...
            {n:"5",t:"Collect your licence",d:"Your Singapore licence is typically issued at the appointment or mailed within 3â5 working days. The fee is approximately SGD $50."},
          ].map(({n,t,d}) => (
        ...
        <div style={{background:"white",border:"1px solid #e5e7eb",borderRadius:10,padding:24,margin:"16px 0 28px"}}>
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20}}>
            {[["Application fee","~SGD $50"],["Processing time","Same day (usually)"],["Licence validity","Typically 5 years"],["Appointment wait","1â3 weeks typically"]].map(([l,v]) => (
        ...
        <PatrickTip city="sg">"Book the Traffic Police appointment as soon as you arrive â slots fill up. I waited three weeks, drove on my UK licence the whole time, and was absolutely fine. But it's one of those things you want ticked off early rather than remembering it at month 11."</PatrickTip>
      </div>
    </Layout>
  );
}

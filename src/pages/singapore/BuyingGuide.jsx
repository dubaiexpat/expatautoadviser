...
export default function SGBuyingGuide() {
  return (
    <Layout city="sg" active="Buying Guide" relatedLinks={[{ label: 'Should I Get a Car?', to: '/singapore/should-i-get-a-car' }, { label: 'Insurance Guide', to: '/singapore/insurance-guide' }, { label: 'Licence Conversion', to: '/singapore/licence-conversion' }, { label: 'Cost Calculator', to: '/singapore/calculators' }]}>
      ...
      <div style={note}>
        <strong>PARF rebate — updated Feb 2026:</strong> If you scrap a car within the first 5 years, you get a 30% PARF rebate on the ARF paid (previously 75%), capped at SGD $30,000 (previously $60,000). Between 5–9 years it steps down further. This is why many expats who buy deliberately plan their ownership period around the rebate schedule.
      </div>

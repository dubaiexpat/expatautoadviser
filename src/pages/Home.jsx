    ...
    return (
      <Link to={to} style={{ textDecoration: "none", display: "block", position: "relative", overflow: "hidden", height: "260px" }}
        ...
        <div style={{ position: "relative", zIndex: 2, height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-end", padding: "0 24px 28px", textAlign: "center", gap: "10px" }}>
          ...
          <div style={{ padding: "10px 28px", borderRadius: "40px", background: "#fff", color: accent, fontWeight: 700, fontSize: "12px", letterSpacing: "0.1em", textTransform: "uppercase" }}>I'm in {city} →</div>
        </div>
      </Link>
    );
  }
    ...
    <div style={{ minHeight: "100vh", background: "#0a0c12" }}>
      ...
      <div style={{ background: "#0d1117", borderTop: "1px solid rgba(255,255,255,0.06)", padding: isMobile ? "36px 24px" : "52px 40px", display: "flex", flexDirection: isMobile ? "column" : "row", alignItems: "center", justifyContent: "center", gap: isMobile ? "20px" : "36px", textAlign: isMobile ? "center" : "left" }}>
        ...
        <div style={{ maxWidth: "540px" }}>
          <p style={{ margin: "0 0 10px", fontFamily: "'Playfair Display',Georgia,serif", fontSize: isMobile ? "16px" : "clamp(16px,1.8vw,20px)", color: "#fff", lineHeight: 1.6, fontStyle: "italic" }}>
      ...
      {/* NEWSLETTER — lead magnet: free Expat Car Checklist */}
      <div style={{ background: "#080b11", borderTop: "1px solid rgba(255,255,255,0.04)", padding: isMobile ? "40px 20px" : "56px 40px", display: "flex", flexDirection: "column", alignItems: "center", gap: "20px", textAlign: "center" }}>
        <div style={{ background: "rgba(232,52,28,0.08)", border: "1px solid rgba(232,52,28,0.2)", borderRadius: 10, padding: "14px 24px", maxWidth: 480 }}>
          ...
          <p style={{ margin: 0, fontSize: isMobile ? "16px" : "18px", fontWeight: 700, color: "#fff", lineHeight: 1.4 }}>Get the Expat Car Checklist</p>
          <p style={{ margin: "8px 0 0", fontSize: "13px", color: "rgba(255,255,255,0.55)", lineHeight: 1.5 }}>
            The 12 questions to ask before you sign any lease or buy any car in Singapore or HK. Used by 600+ expats.
          </p>
        </div>
        <div style={{ display: "flex", width: "100%", maxWidth: "420px" }}>
          <input type="email" placeholder="your@email.com" style={{ flex: 1, padding: "13px 16px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRight: "none", borderRadius: "6px 0 0 6px", color: "#fff", fontSize: "14px", outline: "none" }} />
          <button style={{ padding: "13px 22px", background: "#e63946", color: "#fff", border: "none", borderRadius: "0 6px 6px 0", fontWeight: 700, fontSize: "13px", cursor: "pointer", whiteSpace: "nowrap" }}>Send me the checklist →</button>
        </div>
